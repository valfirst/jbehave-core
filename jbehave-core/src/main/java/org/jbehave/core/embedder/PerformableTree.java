...
public class PerformableTree {
	...
	private void addStepsWithLifecycle(AbstractPerformableScenario performableScenario, RunContext context,
        ...
        performableScenario.addGivenStories(
                performableGivenStories(context, scenario.getGivenStories(), parameters, storyAndScenarioMeta));
    ...
    public static abstract class AbstractPerformableScenario implements Performable {
        ...
        protected void performBeforeScenario(RunContext context) throws InterruptedException {
        ...
        protected void performAfterScenario(RunContext context) throws InterruptedException {
            StoryReporter reporter = context.reporter();
