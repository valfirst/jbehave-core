...
public class Keywords {
    ...
    public static final String COMPOSITE_STEP = "CompositeStep";
    ...
    public static final List<String> KEYWORDS = asList(META, META_PROPERTY, NARRATIVE, IN_ORDER_TO, AS_A, I_WANT_TO, SO_THAT,
            ...
            EXAMPLES_TABLE_VALUE_SEPARATOR, EXAMPLES_TABLE_IGNORABLE_SEPARATOR, GIVEN, WHEN, THEN, AND, IGNORABLE, COMPOSITE_STEP,
    ...
    private final String compositeStep;
    ...
    public static Map<String, String> defaultKeywords() {
        ...
        keywords.put(COMPOSITE_STEP, "Composite step:");
    ...
    public Keywords(Map<String, String> keywords) {
        ...
        this.compositeStep = keyword(COMPOSITE_STEP, keywords);
