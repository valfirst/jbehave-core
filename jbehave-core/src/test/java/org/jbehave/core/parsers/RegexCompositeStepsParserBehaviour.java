...
public class RegexCompositeStepsParserBehaviour {
    ...
    public void shouldParseSingleCompositeStep() {
        String compositeStepsAsText = "Composite step: Given a composite step" + NL+
                "Given a step" + NL +
                "Then another step";
    ...
    public void shouldParseTwoCompositeStep() {
        String compositeStepsAsText = "Composite step: Given the first composite step" + NL+
                "Given a step" + NL +
                "Composite step: When the second composite step" + NL+
    ...
    public void shouldParseCompositeStepWithCustomLocale() {
        String compositeStepsAsText = "Композитный шаг: Дано композитный шаг" + NL+
                "Дано шаг";
