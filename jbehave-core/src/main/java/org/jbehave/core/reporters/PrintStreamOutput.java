...
public abstract class PrintStreamOutput extends NullStoryReporter {
    ...
    public void beforeScenario(Scenario scenario) {
        ...
        List<String> rawSteps = scenario.getRawSteps();
        if (rawSteps != null) {
    ...
    public void example(Map<String, String> tableRow, int exampleIndex) {
        ...
        for (Map.Entry<String, String> cell : tableRow.entrySet()) {
            print(output, format("exampleParameter", EMPTY, cell.getKey(), cell.getValue()));
        }
