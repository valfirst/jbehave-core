...
public class PrintStreamOutputBehaviour extends AbstractOutputBehaviour {
    ...
    public void shouldReportEventsToJsonOutputScenarioGivenStoriesWithMultipleExamples()
    {
        ...
        String expected = "{\"path\": \"\\/path\\/to\\/story\", \"title\": \"An interesting story & special chars\",\"scenarios\": [{\"keyword\": "
                + "\"Scenario:\", \"title\": \"I ask for a loan\",\"rawSteps\": [],\"beforeScenarioSteps\": [{\"steps\": [],\"outcome\": \"successful\", \"value\": "
    ...
    public void shouldReportEventsToJsonOutputScenarioNestedGivenStoriesWithMultipleExamplesAndLifecycles()
    {
        ...
        String expected = "{\"path\": \"\\/path\\/to\\/story\", \"title\": \"Root story\",\"lifecycle\": {\"keyword\": \"Lifecycle:\",\"parameters\": "
                ...
                + "[{\"keyword\": \"Scenario:\", \"title\": \"My scenario\",\"rawSteps\": [],\"beforeScenarioSteps\": [{\"steps\": [],\"outcome\": \"successful\", "
                ...
                + "\"row2\"]]}},\"beforeStorySteps\": [],\"scenarios\": [{\"keyword\": \"Scenario:\", \"title\": \"My scenario\",\"rawSteps\": [],\"beforeScenarioSteps\": "
                ...
                + " \"title\": \"My scenario\",\"rawSteps\": [],\"beforeScenarioSteps\": [{\"steps\": [],\"outcome\": \"successful\", \"value\": \"When before scenario steps\"}],"
    ...
    public void shouldReportRawStepsToJsonOutput() {
        ...
        Scenario scenario = new Scenario("Main scenario", Meta.EMPTY, null, null,
                Collections.<String> singletonList(step));
    ...
    public void shouldReportEventsToJsonOutputEmptyScenarioLifecycle()
    {
        ...
        String expected = "{\"path\": \"\\/path\\/to\\/story\", \"title\": \"Story with lifecycle and empty scenario\",\"lifecycle\": "
                ...
                + "data\"]]}},\"scenarios\": [{\"keyword\": \"Scenario:\", \"title\": \"Normal scenario\",\"rawSteps\": [],\"examples\": {\"keyword\": \"Examples:\""
                ...
                + "{\"keyword\": \"Scenario:\", \"title\": \"Some empty scenario\",\"rawSteps\": [],\"examples\": {\"keyword\": "
    ...
    public void shouldReportEventsToJsonOutputNestedSteps()
    {
        ...
        String expected = "{\"path\": \"\\/path\\/to\\/story\", \"title\": \"Nested steps\","
                ...
                + "scenario\",\"rawSteps\": [],\"steps\": [{\"steps\": [],\"outcome\": \"successful\", "
    ...
    public void shouldReportEventsToJsonOutputPendingSteps()
    {
        ...
        String expected = "{\"path\": \"\\/path\\/to\\/story\", \"title\": \"Pending steps\",\"scenarios\": "
                + "[{\"keyword\": \"Scenario:\", \"title\": \"Pending steps scenario\",\"rawSteps\": [],\"steps\": [{\"steps\": [],"
